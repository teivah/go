...
func (b *bitState) reset(prog *syntax.Prog, end int, ncap int) {
	...
	if cap(b.jobs.arg) == 0 {
		b.jobs.arg = make([]bool, 0, 256)
		b.jobs.pc = make([]uint32, 0, 256)
		b.jobs.pos = make([]int, 0, 256)
	} else {
		b.jobs.arg = b.jobs.arg[:0]
		b.jobs.pc = b.jobs.pc[:0]
		b.jobs.pos = b.jobs.pos[:0]
	}
...
func (b *bitState) push(re *Regexp, pc uint32, pos int, arg bool) {
	...
	if re.prog.Inst[pc].Op != syntax.InstFail && (arg || b.shouldVisit(pc, pos)) {
		b.jobs.pos = append(b.jobs.pos, pos)
		b.jobs.pc = append(b.jobs.pc, pc)
		b.jobs.arg = append(b.jobs.arg, arg)
	}
}
...
func (re *Regexp) tryBacktrack(b *bitState, i input, pc uint32, pos int) bool {
	...
	for len(b.jobs.pos) > 0 {
		l := len(b.jobs.pos) - 1
		// Pop job off the stack.
		pc := b.jobs.pc[l]
		pos := b.jobs.pos[l]
		arg := b.jobs.arg[l]
		b.jobs.pc = b.jobs.pc[:l]
		b.jobs.pos = b.jobs.pos[:l]
		b.jobs.arg = b.jobs.arg[:l]
